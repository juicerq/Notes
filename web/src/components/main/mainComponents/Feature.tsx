...
export default function Feature(props: FeatureProps) {
  ...
  return (
    <motion.div
      ...
      className="item flex min-h-[280px] flex-col justify-start gap-4 rounded-lg bg-gradient-to-br from-[#303030] to-[#262626] px-6 py-8 text-white shadow-md md:min-h-[260px] lg:w-[250px] lg:flex-none xl:w-[320px] 2xl:w-[400px]"
    >
