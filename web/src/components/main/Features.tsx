...
export default function Features() {
  return (
    <div
      id="features"
      className="section-spacing flex flex-col items-center justify-center 2xl:py-36"
    >
      <div className="flex flex-col items-center justify-center lg:w-full">
        <div className="w-full">
          <h3 className=" px-4 pb-8 text-center font-main text-3xl text-mainPalette-bg md:py-16 lg:pb-24 lg:pt-0">
