    ...
    >
      <div className="flex flex-col items-center justify-center lg:w-full">
        ...
        <div className="flex h-full flex-col lg:gap-6">
          <div className="relative flex w-screen snap-x snap-mandatory scroll-p-3 gap-6 overflow-auto overflow-y-hidden p-3 lg:w-full lg:snap-none lg:scroll-p-0 lg:flex-wrap lg:overflow-hidden lg:p-0">
            <Feature
          ...
          <div className="flex w-screen snap-x snap-mandatory scroll-p-3 gap-6 overflow-auto overflow-y-hidden p-3 lg:w-full lg:snap-none lg:scroll-p-0 lg:flex-wrap lg:overflow-hidden lg:p-0  lg:pb-12">
            <Feature
              delay={3}
