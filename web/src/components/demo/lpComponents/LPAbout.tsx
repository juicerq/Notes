...
export function LPAbout() {
  return (
    <div
      id="lp-about"
      className="section-spacing flex flex-col items-center justify-center gap-16 bg-demoPalette-bg"
    >
      ...
      <div className="flex flex-col items-center justify-center gap-14 text-demoPalette-bg xl:flex-row 2xl:gap-40">
        {/* About Card */}
        <div className="flex flex-col items-center justify-center gap-6 rounded-xl bg-demoPalette-bgAlt p-6 md:w-72">
          ...
          <h4 className="text-2xl font-bold ">Exemplo 1</h4>
